...
ggplot(datos_uso_tiempo, aes(trabajo_pago)) +
  geom_histogram(aes(color=sexo), fill = "white", alpha = 0.15, position = "stack") +
  labs(title = "Personas según cantidad de horas trabajadas por sexo",
       x = "Horas trabajadas",
